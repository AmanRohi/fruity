  ...
  return (
    <section className='grid grid-cols-1 lg:grid-cols-2 gap-2 w-full'>
      <div className='py-2 flex-1  flex flex-col items-start   gap-4 '>
        ...
        <p className='text-base text-textColor text-center md:text-left md:w-[80%] lg:text-md mb-8'>
        ...
        <motion.button while={{scale:0.75}}
      ...
      <div className='py-2 flex-1 flex relative'>
            ...
            <div className='w-full h-full absolute lg:-top-3 left-0 flex justify-center lg:justify-start    flex-wrap content-center lg:content-start lg:mt-6 px-2 md:px-28 md:gap-24 lg:px-[16%] py-12 lg:gap-y-20 gap-y-16 gap-2 lg:gap-4 '>
              {data&&data.map((item)=>{
                return <motion.div  
                initial={{opacity:0}}
                animate={{opacity:1}}
